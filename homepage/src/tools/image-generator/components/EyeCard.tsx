  ...
  return (
    ...
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-start px-0 py-[9px] relative w-full gap-2">
          <Hero />
          <textarea
            className="w-full resize-none bg-transparent outline-none font-['Inter:Medium',_sans-serif] font-medium text-[24px] text-[#000000] min-h-[80px] leading-normal placeholder:text-[#00000055]"
